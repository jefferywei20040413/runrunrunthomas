...
def reset_game(level_index=0):
    global mario, all_sprites, enemies, platforms, fireballs, powerups, enemies_total_count, player_score, mario_lives, game_win, game_over, achievements, camera, current_level, MAP_WIDTH, particles, boss_bullets
    ...
    all_sprites.add(fireballs, boss_bullets,particles)
